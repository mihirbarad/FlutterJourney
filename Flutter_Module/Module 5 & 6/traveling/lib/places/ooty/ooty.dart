...
class ooty extends StatefulWidget {
  const ooty({super.key});

  @override
  State<ooty> createState() => ootyState();
}

class ootyState extends State<ooty> {
  bool isVisibal = true;
  @override
  List imageurl = [
    ...
    'https://upload.wikimedia.org/wikipedia/commons/c/c1/Botanical_Gardens_-_Ootacamund_%28Ooty%29_-_India_03.JPG',
