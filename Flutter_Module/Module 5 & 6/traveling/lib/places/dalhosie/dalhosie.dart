...
class Dalhosie extends StatefulWidget {
  const Dalhosie({super.key});

  @override
  State<Dalhosie> createState() => _DalhosieState();
}

class _DalhosieState extends State<Dalhosie> {
  bool isVisibal = true;
  @override
  List imageurl = [
    'https://apnatours.in/uploads/1531400029-dalhousie.jpg',
    'https://www.shrineyatra.com/wp-content/uploads/2021/09/Chamba-Tour-Package.jpg',
    'https://images.thrillophilia.com/image/upload/s--Sb2loCN8--/c_fill,g_auto,h_600,q_auto,w_975/f_auto,fl_strip_profile/v1/images/photos/000/127/059/original/1523601716_Khajjiar.jpg.jpg?1523601715',
    'https://www.holidify.com/images/cmsuploads/compressed/Screenshot2020-12-05at3.42.30PM_20201205154251.png',
  ];
