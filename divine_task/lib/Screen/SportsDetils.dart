...
class SportInformation extends StatefulWidget {
  const SportInformation({super.key});

  @override
  State<SportInformation> createState() => _SportInformationState();
}

class _SportInformationState extends State<SportInformation> {
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsets.only(left: 30.w, bottom: 4.h),
                        child: Container(
                          height: 30,
                          width: 30,
                          decoration: BoxDecoration(
